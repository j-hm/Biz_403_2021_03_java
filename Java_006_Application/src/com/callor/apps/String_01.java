...
public class String_01 {
	public static void main(String[] args) {
		...
		// 표현은 작은따옴표('')로 감싼다
		// 문자는 알파벳으로 읽히지만
		// 변수에 저장될 떄는 정수형 ASCII 코드값으로 저장된다
		// 그래서 정수와 사칙연산이 가능하다
		char char1 = 'A'; // 문자, 알파벳은 한 글자만, 아스키

		// 문자열 변수 : 문자들의 묶음 변수
		String str1 = "대한민국만세"; // 문자열
		...
		// 알파벳 단위로 잘라서 배열로 만들어라
		str3 = str1.split(""); // Space(스페이스) 없음
		for (int i = 0; i < str3.length; i++) {
			System.out.println(str3[i]);
		}
